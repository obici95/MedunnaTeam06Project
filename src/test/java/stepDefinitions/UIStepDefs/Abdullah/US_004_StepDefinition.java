...
public class US_004_StepDefinition {
    ...
    @Then("AA Kullanici, daha onceden olusturmus oldugu {string}nı girer")
    ...
    @And("AA Kullanici, daha onceden oluşturmuş oldugu {string}unu girer")
    ...
    @And("AA Kullanici, kullanici ismi uzerine tiklar")
    public void kullaniciKullaniciIsmiUzerineTiklar() {
        uS4Page.Team06.click();
    }

    @And("AA Kullanici, kullanici ismi altinda açilan sign out butonuna tiklar")
    public void kullaniciKullaniciIsmiAltindaAçilanSignOutButonunaTiklar() {
        uS4Page.signOut.click();
    }

    @And("AA Kullanici, username alaninda daha once girdigi ismin oldugunu dogrular")
    ...
    @And("AA Kullanici, sayfayi kapatir.")
